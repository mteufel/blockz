...
* = $2000 "Blockz Code"
#import "intro.asm"    // code for the intro
#import "game.asm"     // game logic and loop
#import "level.asm"    // draw the level onto the screen
#import "input.asm"    // joystick and keyboard handling
#import "mover.asm"    // all code for moving the bitmap->sprite converted objects over the screen
#import "objects.asm"  // routine for sprite handling and all kinds of graphicals objects
                       // has to be the last import because it fills also $5000+ with lots of sprite data


* = $A100 "Graphics"
#import "graphics.asm"  // some help routines for graphics and most of the graphics data


* = $8000 "Level Data" 
#import "levels.asm"    // level code generated by the leveleditor
